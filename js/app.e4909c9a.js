(function(t) {
    function e(e) {
        for (var a, i, c = e[0], s = e[1], l = e[2], f = 0, d = []; f < c.length; f++) i = c[f],
        o[i] && d.push(o[i][0]),
        o[i] = 0;
    ...
    i.t = function(t, e) {
        ...
        if (i.r(n), Object.defineProperty(n, "default", {
            enumerable: !0,
            value: t
        }), 2 & e && "string" != typeof t) for (var a in t) i.d(n, a,
        function(e) {
            return t[e]
        }.bind(null, a));
        return n
    ...
    "56d7": function(t, e, n) {
        ...
        z = {
            ...
            watch: {
                active: function() {
                    ...
                    e = this.active,
                    n = this.data.length;
                    e >= 10 && e <= n && (document.querySelector(".left-bar").scrollTop = t + 60),
                    e < 10 && e >= 0 && (document.querySelector(".left-bar").scrollTop = t - 60)
                }
            },
            methods: {
                jump: function(t) {
                ...
                dataScroll: function() {
                    ...
                    n = document.querySelectorAll(".box"), a = 0; a < n.length; a++) e >= n[a].offsetTop && (t.selfIndex = a)
                },
                handleScroll: function() {
                    for (var t = this,
                    e = t.data.length,
                    n = document.querySelectorAll(".box"), a = document.body.scrollTop || document.documentElement.scrollTop, o = e - 1; o >= 0; o--) if (a >= n[o].offsetTop - 20) {
                        t.active = o.toString();
                        break
                    }
                }
            ...
            created: function() {
                ...
                window.onresize = function() {
                    return function() {
                        window.screenWidth = document.body.clientWidth,
                        window.screenWidth < 481 ? t.isLeftbar = !1 : t.isLeftbar = !0
                    } ()
                },
                window.onresize()
            }
        ...
        a["default"].use(B.a),
        a["default"].prototype.$storage = F,
        a["default"].prototype.$http = r.a,
        a["default"].config.productionTip = !1,
        new a["default"]({
            router: P,
            render: function(t) {
